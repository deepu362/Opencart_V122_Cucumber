...
public class BaseClass {
    ...
    private static final String LT_USERNAME = "deepu362"; // your user name
    private static final String LT_ACCESS_KEY = "FRlKtlRz5RChkbXN55ObBRBh7OeRNCcRq0X33yJrNie8DRdzls"; // your password
